...
hl.bind("SUPER + B", hl.dsp.exec_cmd("qs -c cleaner ipc call cleaner toggle"), {
    description = "Shell: Toggle cleaner"
})
hl.bind("SUPER + O", hl.dsp.exec_cmd("obs"), { description = "App: OBS Studio" })
hl.bind("SUPER + T", hl.dsp.exec_cmd("qs -c monitor-settings ipc call monitorSettings toggle"), { description = "Shell: Monitor Configuration" })
hl.bind("SUPER + N", hl.dsp.global("quickshell:sidebarRightToggle"), { description = "Shell: Toggle right sidebar" })
hl.bind("SUPER + ALT + K", hl.dsp.exec_cmd("qs -c tools ipc call tools calculator"), { description = "Utilities: Calculator" })
hl.bind("SUPER + mouse_down", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%-"), { description = "Media: Volume Up" })
hl.bind("SUPER + mouse_up",   hl.dsp.exec_cmd("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 2%+"), { description = "Media: Volume Down" })
...
hl.bind("SUPER + SPACE", hl.dsp.exec_cmd(grimhyprctl .. " - | wl-copy"),
    { locked = true, description = "Utilities: Screenshot >> clipboard" })
hl.bind("CTRL + SUPER + SPACE", hl.dsp.exec_cmd(
...
hl.bind("SUPER + SHIFT + P", hl.dsp.exec_cmd("poweroff"),
    { locked = true, description = "Session: Shutdown" })
...
hl.bind("SUPER + X", hl.dsp.exec_cmd("steam"), { description = "App: Steam" })
